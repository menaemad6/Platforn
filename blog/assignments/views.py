...
def dashboard_assignments(request):
    ...
    return render(request, 'dashboard/assignments.html', {'user_profile': user_profile , 'notifications' : notifications_count , 'assignments' : assignments , 'posts':teacher_posts , 'questions_count' : questions_count})
...
def assignment_applicants(request , slug):
    ...
    return render(request, 'dashboard/assignment-applicants.html', {'user_profile': user_profile , 'notifications' : notifications_count , 'assignment' : assignment , 'applicants' : applicants , 'questions_count':no_of_questions})
