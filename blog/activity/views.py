...
def grades(request):
    ...
    lessons = Post.objects.filter(year=year , type='normal').order_by('-created_at')
...
def old_assignment_submit(request):
    if request.method == 'POST':
        ...
        # if request.POST['question1']:
        #     question1 = request.POST['question1']
        # else:
        #     question1 = ''

        # if request.POST['question2']:
        #     question2 = request.POST['question2']
        # else:
        #     question2 = ''
        
        # if request.POST['question3']:
        #     question3 = request.POST['question3']
        # else:
        #     question3 = ''
        
        # if request.POST['question4']:
        #     question4 = request.POST['question4']
        # else:
        #     question4 = ''
        
        # if request.POST['question5']:
